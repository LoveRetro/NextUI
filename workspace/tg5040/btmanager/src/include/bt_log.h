...
#define btmg_printf(level, fmt, arg...) btmg_print(level, "%s:%u: " fmt "\n", __FUNCTION__, __LINE__, ##arg)
#else
#define btmg_printf(level, fmt, arg...) btmg_print(level, fmt "\n", ##arg)
#endif /*CONFIG_DEBUG_FUNCTION_LINE*/

#define BTMG_PRTK(level, fmt, arg...) btmg_print(level, "BTMG[%s:%u]:  " fmt "", __func__, __LINE__, ##arg)

#define BTMG_DEBUG(fmt, arg...) btmg_print(MSG_DEBUG, "BTMG[%s:%u]:  " fmt "\n", __func__, __LINE__, ##arg)

#define BTMG_INFO(fmt, arg...) btmg_print(MSG_INFO, "BTMG[%s:%u]:  " fmt "\n", __func__, __LINE__, ##arg)

#define BTMG_WARNG(fmt, arg...) btmg_print(MSG_WARNING, "BTMG[%s:%u]:  " fmt "\n", __func__, __LINE__, ##arg)

#define BTMG_ERROR(fmt, arg...) btmg_print(MSG_ERROR, "BTMG[%s:%u]:  " fmt "\n", __func__, __LINE__, ##arg)

#define BTMG_DUMP(fmt, arg...) btmg_print(MSG_MSGDUMP, "BTMG[%s:%u]:	" fmt "\n", __func__, __LINE__, ##arg)

#define BTMG_EXCESSIVE(fmt, arg...) btmg_print(MSG_EXCESSIVE, "BTMG[%s:%u]:	" fmt "\n", __func__, __LINE__, ##arg)

void btmg_print(int level, const char *fmt, ...) PRINTF_FORMAT(2, 3);
