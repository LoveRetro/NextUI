...
enum DeviceType { DEVICE_BLUETOOTH, DEVICE_USB_AUDIO };
...
{
	DBusMessage *msg =
		dbus_message_new_method_call("org.bluez", path.c_str(), "org.freedesktop.DBus.Properties", "Get");
	if (!msg)
		return false;
...
int main(int argc, char *argv[])
{
	...
	dbus_bus_add_match(conn, "type='signal',interface='org.freedesktop.DBus.Properties',member='PropertiesChanged'",
					   nullptr);
