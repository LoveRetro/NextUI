...
namespace {
    ...
    public:
        ...
        int defaultDisplayCalRedGain() const {
            return 100;
        }

        int defaultDisplayCalGreenGain() const {
            return m_model == Brick ? 92 : 100;
        }

        int defaultDisplayCalBlueGain() const {
            return m_model == Brick ? 58 : 100;
        }
